    ...
    <body>
        ...
        <script>
                            ...
                            function getWesternZodiac(day, month) {
                                const zodiacs = [
                                    {name: "Ma Kết", image: "./assets/images/zodiac-sign/capricorn.png", start: {month: 12, day: 22}, end: {month: 1, day: 19}},
                                    {name: "Bảo Bình", image: "./assets/images/zodiac-sign/aquarius.png", start: {month: 1, day: 20}, end: {month: 2, day: 18}},
                                    {name: "Song Ngư", image: "./assets/images/zodiac-sign/pisces.png", start: {month: 2, day: 19}, end: {month: 3, day: 20}},
                                    ...
                                    {name: "Bọ Cạp", image: "./assets/images/zodiac-sign/scorpio.png", start: {month: 10, day: 23}, end: {month: 11, day: 21}},
                                    {name: "Nhân Mã", image: "./assets/images/zodiac-sign/sagittarius.png", start: {month: 11, day: 22}, end: {month: 12, day: 21}}
                                ];
