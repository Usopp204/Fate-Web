        ...
        <main class="container">
            <div class="main-content" id="main-content">
                <div id="horoscope-overview-container">
                    <%= request.getAttribute("contentForWesternFeature2")%>
                </div>

                <form action="westernfeature2" method="post">
                    <div class="horoscope-search">
                        <input type="number" id="birth-day" name="day" placeholder="Enter your date of birth" required>
                        <input type="number" id="birth-month" name="month" placeholder="Enter your birth month" required>
                        <button id="search-horoscope">Find Zodiac</button>
                    </div>
                </form>
            ...
            <div class="container">
                <div class="footer-content">
                    <div class="footer-left">
                        <img src="./assets/images/your-logo.png" alt="Company Logo" class="footer-logo">
